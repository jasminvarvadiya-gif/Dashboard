    ...
    <>
      <div className="container">
        <div className="content">
          <div className="w-full fixed z-[999] bg-black/50 backdrop-blur py-4 md:py-8 flex px-4 md:px-15 items-center font-['font-1'] justify-between">
            <div className="logo w-12 md:w-18">
            ...
            <div className="hidden md:flex link gap-4 lg:gap-10">
              {["Services", "Our Contact", "About us", "Insights", "Contact"].map((item, index) => (
                <a key={index} className={`text-sm lg:text-lg capitalize font-light hover:text-[#cdea68] transition ${index === 4 && "pl-10" }`}>
                  {item}
                </a>
              ))}
            </div>
          ...
          {isOpen && (
            <div className="fixed top-16 left-0 right-0 bg-black z-[998] md:hidden p-4">
